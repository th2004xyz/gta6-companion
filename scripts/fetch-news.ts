...
title_en: ${yamlString(title)}
status: speculated
last_updated: ${date}
date: ${date}
author: ${yamlString(author)}
summary: ${yamlString(summary)}
summary_en: ${yamlString(summary)}
sources:
  - label:
...
> AUTO-FETCHED DRAFT from ${sourceName} RSS. Editor TODO:
> 1. Translate \`title\` and \`summary\` to Chinese (keep title_en/summary_en as-is)
> 2. Replace Chinese placeholder below with real Chinese summary/body
> 3. Update \`status\` if needed (confirmed / speculated / leaked)
> 4. Delete this TODO block before publishing
